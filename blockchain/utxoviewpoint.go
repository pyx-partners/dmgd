...
func (view *UtxoViewpoint) AddTxOuts(tx *provautil.Tx, blockHeight uint32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *provautil.Tx, blockHeight uint32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *provautil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *provautil.Block, stxos []spentTxOut) error {
...
func (b *BlockChain) FetchUtxoView(tx *provautil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
