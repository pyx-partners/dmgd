...
(http://godoc.org/github.com/pyx-partners/dmgd/peer)
...
primitives necessary to speak the p2p wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe Prova peer for handling Prova
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling Prova protocol messages
...
```bash
$ go get -u github.com/pyx-partners/dmgd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/pyx-partners/dmgd/peer#example-package--NewOutboundPeer)
