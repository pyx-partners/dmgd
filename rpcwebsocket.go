...
//
// NOTE: This extension was ported from github.com/decred/dcrd
func (f *wsClientFilter) addAddress(a provautil.Address) {
...
func (f *wsClientFilter) addAddressStr(s string) {
	...
	// script.
	a, err := provautil.DecodeAddress(s, activeNetParams.Params)
	if err != nil {
		return
	}
	f.addAddress(a)
...
//
// NOTE: This extension was ported from github.com/decred/dcrd
func (f *wsClientFilter) existsAddress(a provautil.Address) bool {
...
//
// NOTE: This extension was ported from github.com/decred/dcrd
func (f *wsClientFilter) removeAddress(a provautil.Address) {
...
func (m *wsNotificationManager) subscribedClients(tx *provautil.Tx,
...
func (m *wsNotificationManager) notifyFilteredBlockConnected(clients map[chan struct{}]*wsClient,
	...
	ntfn := btcjson.NewFilteredBlockConnectedNtfn(int32(block.Height()),
...
func (*wsNotificationManager) notifyFilteredBlockDisconnected(clients map[chan struct{}]*wsClient,
	...
	ntfn := btcjson.NewFilteredBlockDisconnectedNtfn(int32(block.Height()),
...
func (m *wsNotificationManager) notifyForNewTx(clients map[chan struct{}]*wsClient, tx *provautil.Tx) {
	...
	ntfn := btcjson.NewTxAcceptedNtfn(txHashStr, provautil.Amount(amount).ToDMG())
	marshalledJSON, err := btcjson.MarshalCmd(nil, ntfn)
	if err != nil {
...
// notifications.
func (m *wsNotificationManager) notifyRelevantTxAccepted(tx *provautil.Tx,
...
//
// NOTE: This extension is ported from github.com/decred/dcrd
func rescanBlockFilter(filter *wsClientFilter, block *provautil.Block) []string {
