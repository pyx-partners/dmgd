...
func (c *TestCoin) Value() provautil.Amount      { return c.TxValue }
...
func NewCoin(index int64, value provautil.Amount, numConfs int64) coinset.Coin {
	h := fastsha256.New()
...
var (
	// should be two outpoints, with 1st one having 3.5RMG value.
	...
	testSimpleCoinTxValue0            = provautil.Amount(3500000)
	...
	testSimpleCoinTx, _               = provautil.NewTxFromBytes(testSimpleCoinTxBytes)
